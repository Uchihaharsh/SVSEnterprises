...
const TechnicalComparison = () => {
  const specifications = [
    ...
    { name: 'How to Use it?', cylinder2kg: 'Pull - Aim - Squeeze - Sweep', cylinder5kg: 'Pull - Aim - Squeeze - Sweep', agniKawach: 'Just throw into the fire' },
          ...
          <table className="w-full border-collapse border border-gray-300 dark:border-gray-700">
            <thead>
              <tr className="bg-gray-100 dark:bg-gray-800">
                <th className="border border-gray-300 dark:border-gray-700 p-4 text-left font-bold">Specification</th>
                <th className="border border-gray-300 dark:border-gray-700 p-4 text-left font-bold">Cylinder 2 KG</th>
                <th className="border border-gray-300 dark:border-gray-700 p-4 text-left font-bold">Cylinder 5 KG</th>
                <th className="border border-gray-300 dark:border-gray-700 p-4 text-left font-bold">Agni Kawach</th>
              </tr>
            </thead>
